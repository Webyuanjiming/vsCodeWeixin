...
app.config(function($routeProvider) {
    ...
    $routeProvider.when('/', {
        templateUrl: '/m/sign/home.html',
        reloadOnSearch: false,
        controller: 'SignController'
    }).when('/list', {
        templateUrl: '/m/sign/list.html',
        reloadOnSearch: false,
        controller: 'SignController'
    });
});
...
/**签到场景**/
app.controller('SignController', ['$rootScope', '$scope', '$routeParams', '$timeout', '$location', 'baseService',
    function($rootScope, $scope, $routeParamsp, $timeout, $location, service) {
